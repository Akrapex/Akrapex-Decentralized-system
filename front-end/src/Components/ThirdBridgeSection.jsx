...
import { ThirdBridgeData } from '../Constants/ThirdBridgeData';
import { Link } from 'react-router-dom';

const ThirdBridgeSection = () => {
  return (
    <>
      <div>
      ...
      <div className="grid grid-cols-2 gap-20 mb-40">
        {ThirdBridgeData.map(({ id, image, title, description, list }) => (
          <div
...
export default ThirdBridgeSection
