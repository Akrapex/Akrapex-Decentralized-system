  ...
  return (
    <div className="max-w-[1440px] w-full mx-auto flex items-center justify-between py-28">
      <div className="py-40">
        ...
        <button className="text-xl text-white font-medium font-inter bg-tertiary py-2 px-10 rounded-[20px] mt-40">
          Learn more
        </button>
      </div>
      <div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-10">
          <div className="bg-[#0F1932] w-[330px] h-[374px]  py-20 px-5 rounded-[10px]">
            <img
          ...
          <div className="bg-[#0F1932] w-[330px] h-[374px]  py-20 px-5 rounded-[10px] mt-10">
            <img
